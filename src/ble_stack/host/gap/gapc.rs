pub mod task {
    pub use crate::bindings::{
        ...
        gapc_msg_id::{
            GAPC_GET_INFO_CMD, GAPC_PARAM_UPDATED_IND, GAPC_PARAM_UPDATE_CMD,
        ...
        gapc_set_le_pkt_size_cmd as GapcSetLePktSizeCmd,
    };
    ...
    kernel_msg_type!(GapcSetLePktSizeCmd, GAPC_SET_LE_PKT_SIZE_CMD);
}
